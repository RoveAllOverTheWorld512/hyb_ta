...
#    df = BlockReader().get_df(r"D:\new_hxzq_hc\T0002\hq_cache\block_zs.dat")
#    print(df)
#    df2 = BlockReader().get_df(r"D:\new_hxzq_hc\T0002\hq_cache\block_zs.dat", BlockReader_TYPE_GROUP)
#    print(df2)
#    df3 = CustomerBlockReader().get_df(r'D:\new_hxzq_hc\T0002\blocknew')
#    print(df3)
    df4 = CustomerBlockReader().get_df(r'D:\new_hxzq_hc\T0002\blocknew',BlockReader_TYPE_GROUP)
    print(df4)
